...
export default {
  ...
  data() {
    return {
      aboutUs: ['Who we are', 'Quality in the details', 'Customer Reviews', 'Bundles'],
      departments: ['Women fashion', 'Men fashion', 'Kidswear', 'Home'],
      help: ['Customer service', 'Size guide', 'Contact us', 'Terms'],
      paymentsDelivery: ['Purchase Terms', '5 Year Guarantee', 'Delivery', 'Payment'],
